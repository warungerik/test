...
const confirmOrder = () => {
    ...
    if (!name.value) {
        toastify["error"]?.("Whoops!", "Nama pembeli tidak boleh kosong!");
        return;
    }
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="cards mb-4 d-flex flex-column gap-3" id="section-method">
                    <div class="title-card text-left">1. Data Pembeli</div>
                    <div class="floating-label-content">
                        <label class="label-content mb-1" for="target">Nama</label>
                        <input type="text" v-model="name" class="form-control games-input floating-input" name="nama"
                ...
                <div class="cards py-3 mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-6" v-for="d in dataDenom" :key="d.id">
                            <input type="radio" name="product" :id="`denom-${d.id}`" v-model="denom" :value="d.id"
                                class="nom-radio" @click="selectDenom(d)" />
